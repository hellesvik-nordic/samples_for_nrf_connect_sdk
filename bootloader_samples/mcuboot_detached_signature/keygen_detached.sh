...
imgtool2.py sign -v 1.0.0  -H 0x200 -S 0x79e00 --align 8 --fix-sig keys/openssl_sig_base64.sig --fix-sig-pubkey keys/pub.pem --public-key-format full --pad-header  build/zephyr/zephyr.hex signed_app_image.hex
sleep 2
