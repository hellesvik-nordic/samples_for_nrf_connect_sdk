...
imgtool2.py sign -v 1.0.0 -H 0x200 -S 0x67000 --align 8  --fix-sig-pubkey keys/pub.pem --vector-to-sign payload  --pad-header build/zephyr/zephyr.hex keys/data_to_sign.bin
...
imgtool2.py sign -v 1.0.0  -H 0x200 -S 0x67000 --align 8 --fix-sig keys/openssl_sig_base64.sig --fix-sig-pubkey keys/pub.pem --public-key-format full --pad-header  build/zephyr/zephyr.hex signed_app_image.hex
sleep 2
